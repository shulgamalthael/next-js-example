    ...
    return(
        <header className="flex flex-col bg-white">
            <div className="bg-[#fafafa] text-[#05172a]">
                <div className="flex justify-between max-w-[1600px] mx-auto p-4">
                    <nav className="my-auto">
                        <Link href="/about_us" className="text-[14px] p-2 leading-[20px] font-normalr:underline">
                            {t("about_us")}
                        </Link>
                        <Link href="/receipt_and_payment" className="text-[14px] p-2 leading-[20px] font-normal hover:underline">
                            {t("receipt_and_payment")}
                        </Link>
                        <Link href="/returns_and_exchanges" className="text-[14px] p-2 leading-[20px] font-normal hover:underline">
                            {t("returns_and_exchanges")}</Link>
                        <Link href="articles_and_reviews" className="text-[14px] p-2 leading-[20px] font-normal hover:underline">
                            {t("articles_and_reviews")}
                        </Link>
                        <Link href="/faq" className="text-[14px] p-2 leading-[20px] font-normal hover:underline">
                            {t("faq")}
                        </Link>
                        <Link href="/suppliers" className="text-[14px] p-2 leading-[20px] font-normal hover:underline">
                            {t("suppliers")}
                        </Link>
                    </nav>
                    <nav className="flex">
            ...
            <div className="flex bg-white">
                <div className="flex max-w-[1600px] w-[1600px] h-[100px] mx-auto">
                    <div className="p-4">
                    ...
                    <div className="flex flex-col grow-[20] shrink-[2] max-w-[calc(100vw-332px)] my-auto">
                        <div className="flex w-full hover:shadow-2xl hover:shadow-black">
                            <input className="h-[48px] w-full placeholder:text-stone-400 border border-solid border-[rgba(0, 0, 0, 0.12)] gap-[8] text-13px pt-[12px] pr-[4px] pb-[12px] pl-[16px] rounded-tl-[8px] rounded-bl-[8px] cursor-pointer" placeholder="Яку запчастину шукаєте?" />
                ...
                <div className="max-w-[1600px] mx-auto">
                    <nav>
                        <ul className="flex justify-center relative">
                            <li>
                               <Link href="/" className="no-underline p-4 relative h-[48px] leading-[16px] font-medium content-center text-[#fafafa] cursor-pointer">
                                   Все для ТО
                               </Link>
                            </li>
                        </ul>
